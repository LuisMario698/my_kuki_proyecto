...
class BusquedaAgricultor extends StatefulWidget {
  const BusquedaAgricultor({Key? key}) : super(key: key);

  @override
  BusquedaAgricultorState createState() => BusquedaAgricultorState();
}

class BusquedaAgricultorState extends State<BusquedaAgricultor> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [Image.asset("assets/images/agricultor.png", height: 50)],
      ),
      body: Padding(
            ...
            Expanded(
              child: ListView(
                children: [
                  ...
                  _buildProductCard(
                    'Composta de hojas',
                    '1 tonelada de composta de hojas',
                    '\$400',
                    'assets/images/agricultor.png',
                    'assets/images/composta_hojas.jpg',
                  ),
                  _buildProductCard(
                    'Verdura no comercial',
                    '300 kg de verdura economicamente inviable',
                    '\$200',
                    'assets/images/agricultor.png',
                    'assets/images/verdura.jpg',
                  ),
                ],
              ),
            ),
