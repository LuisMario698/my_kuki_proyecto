...
class BusquedaConstruccion extends StatefulWidget {
  const BusquedaConstruccion({Key? key}) : super(key: key);

  @override
  BusquedaConstruccionState createState() => BusquedaConstruccionState();
}

class BusquedaConstruccionState extends State<BusquedaConstruccion> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [Image.asset("assets/images/construccion.png", height: 50)],
      ),
      body: Padding(
            ...
            Expanded(
              child: ListView(
                children: [
                  ...
                  _buildProductCard(
                    'Escombros de bloques',
                    '1 tonelada de escombros de bloques',
                    '\$400',
                    'assets/images/construccion.png',
                    'assets/images/escombros.jpg',
                  ),
                  _buildProductCard(
                    'Escombros de Tablaroca',
                    '300 kg de escombros de Tablaroca',
                    '\$200',
                    'assets/images/construccion.png',
                    'assets/images/tablaroca.jpg',
                  ),
                ],
              ),
            ),
